...
MasterGrab.MasterGrab.IntTextBox
================================

A TextBox accepting only integer as input.
...
namespace MasterGrab {
  ...
  /// <summary>
  /// TextBox accepting integer as input from user. If the user enters an invalid number, he cannot
  /// move the focus away from the IntTextBox.
  /// </summary>
  public class IntTextBox: TextBox {
    ...
    /// </summary>
    public void Set(OptionDef<int> optionDef, int value) {
